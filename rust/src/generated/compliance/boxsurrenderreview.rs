...
pub fn dispatch_open(
    repo: &mut impl crate::kernel::Repository<BoxSurrenderReview>, route: Option<&crate::kernel::RoutingEnvelope>, args: OpenArgs, mutations: &mut Vec<crate::kernel::MutationRecord>, owner_deref: Vec<(&'static str, crate::kernel::DerefNode)>, command_deref: Vec<(&'static str, crate::kernel::DerefNode)>, tenant_boundary_check: Result<(), crate::kernel::Refusal>,
...
if !absent.is_empty() {
    return Err(crate::kernel::Refusal::AbsentArgument(crate::kernel::refusal_wording::AbsentArgumentAbsentArgsArgs {
        ...
        let branch_code = BranchCode::from_json(&(match v.get("branch_code").ok_or_else(|| crate::kernel::Refusal::TypeMismatch("OpenArgs.branch_code expects BranchCode, got nil".to_string()))? { crate::kernel::Json::Null => crate::kernel::Json::Object(Vec::new()), other => other.clone() }).coerce_single_field("value"))?;
        branch_code.check_invariants()?;
        let box_number = BoxNumber::from_json(&(match v.get("box_number").ok_or_else(|| crate::kernel::Refusal::TypeMismatch("OpenArgs.box_number expects BoxNumber, got nil".to_string()))? { crate::kernel::Json::Null => crate::kernel::Json::Object(Vec::new()), other => other.clone() }).coerce_single_field("value"))?;
...
pub fn dispatch_clear(
    repo: &mut impl crate::kernel::Repository<BoxSurrenderReview>, id: &str, args: ClearArgs, mutations: &mut Vec<crate::kernel::MutationRecord>, owner_deref: Vec<(&'static str, crate::kernel::DerefNode)>, command_deref: Vec<(&'static str, crate::kernel::DerefNode)>, tenant_boundary_check: Result<(), crate::kernel::Refusal>,
) -> crate::kernel::DispatchResult<BoxSurrenderReview> {
...
pub fn dispatch_escalate(
    repo: &mut impl crate::kernel::Repository<BoxSurrenderReview>, id: &str, args: EscalateArgs, mutations: &mut Vec<crate::kernel::MutationRecord>, owner_deref: Vec<(&'static str, crate::kernel::DerefNode)>, command_deref: Vec<(&'static str, crate::kernel::DerefNode)>, tenant_boundary_check: Result<(), crate::kernel::Refusal>,
) -> crate::kernel::DispatchResult<BoxSurrenderReview> {
