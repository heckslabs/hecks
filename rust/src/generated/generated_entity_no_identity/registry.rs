...
pub fn dispatch_by_name(
    ...
    match verb {
          "GeneratedEntityNoIdentity::Kiosk.Open" => {
              ...
              let args = if invocation.explicit_with() { let args = crate::kernel::decode_aggregate_arguments(facts_json, &crate::kernel::ArgumentGates { decode_arguments: &crate::generated::generated_entity_no_identity::kiosk::OpenArgs::decode_arguments, refuse_unknown_arguments: &crate::generated::generated_entity_no_identity::kiosk::OpenArgs::refuse_unknown_arguments, refuse_absent_arguments: &crate::generated::generated_entity_no_identity::kiosk::OpenArgs::refuse_absent_arguments, normalize_args: &|v: &crate::kernel::Json| { let args = crate::generated::generated_entity_no_identity::kiosk::OpenArgs::from_json(v)?; args.code.check_invariants()?; Ok(args) }, refuse_role_mismatch: &|| Ok(()), resolve_references: &|_args: &crate::generated::generated_entity_no_identity::kiosk::OpenArgs| Ok(()) })?; if let Some(route) = route { route.require_depth(0)?; } args } else { if let Some(route) = route { route.require_depth(0)?; } crate::kernel::decode_aggregate_arguments(facts_json, &crate::kernel::ArgumentGates { decode_arguments: &crate::generated::generated_entity_no_identity::kiosk::OpenArgs::decode_arguments, refuse_unknown_arguments: &crate::generated::generated_entity_no_identity::kiosk::OpenArgs::refuse_unknown_arguments, refuse_absent_arguments: &crate::generated::generated_entity_no_identity::kiosk::OpenArgs::refuse_absent_arguments, normalize_args: &|v: &crate::kernel::Json| { let args = crate::generated::generated_entity_no_identity::kiosk::OpenArgs::from_json(v)?; args.code.check_invariants()?; Ok(args) }, refuse_role_mismatch: &|| Ok(()), resolve_references: &|_args: &crate::generated::generated_entity_no_identity::kiosk::OpenArgs| Ok(()) })? };
              let tenant_boundary_check: Result<(), crate::kernel::Refusal> = Ok(());
              let owner_deref = Vec::new();
              let command_deref = crate::kernel::command_deref(&*store, REFERENCE_TABLE, &[], &args);
              let payload = crate::kernel::Json::overlay(facts_json, &args.to_json());
              crate::generated::generated_entity_no_identity::kiosk::dispatch_open(&mut store.kiosk, route, args, mutations, owner_deref, command_deref, tenant_boundary_check).map(|(_, events)| stamp_payload(events, &payload))
          }
          "GeneratedEntityNoIdentity::Kiosk.Line.Label" => {
              ...
              let args = crate::kernel::decode_entity_arguments(facts_json, &crate::kernel::ArgumentGates { decode_arguments: &crate::generated::generated_entity_no_identity::kiosk::LineLabelEntityArgs::decode_arguments, refuse_unknown_arguments: &crate::generated::generated_entity_no_identity::kiosk::LineLabelEntityArgs::refuse_unknown_arguments, refuse_absent_arguments: &crate::generated::generated_entity_no_identity::kiosk::LineLabelEntityArgs::refuse_absent_arguments, normalize_args: &|v: &crate::kernel::Json| { let args = crate::generated::generated_entity_no_identity::kiosk::LineLabelEntityArgs::from_json(v)?; args.label.check_invariants()?; Ok(args) }, refuse_role_mismatch: &|| Ok(()), resolve_references: &|_args: &crate::generated::generated_entity_no_identity::kiosk::LineLabelEntityArgs| Ok(()) })?;
              let (parent_id, element_id, element_wants) = match route { Some(route) => { let element_id = route.entities()[0].clone(); (route.aggregate().to_string(), element_id.clone(), element_id) }, None => { let parent_id = crate::generated::generated_entity_no_identity::kiosk::Kiosk::extract_id(facts_json).map_err(|_| crate::kernel::Refusal::NotFound("Label acts on a Kiosk's Line — pass code.value:".to_string()))?; let element_id = crate::generated::generated_entity_no_identity::kiosk::Line::extract_id_lenient(facts_json).map_err(|_| crate::kernel::Refusal::NotFound("Label acts on one Line — pass batch.value, sequence.value:".to_string()))?; let element_wants = crate::generated::generated_entity_no_identity::kiosk::Line::extract_wants(facts_json); (parent_id, element_id, element_wants) }, };
          ...
          "GeneratedEntityNoIdentity::Kiosk.Line.Settle" => {
              ...
              let facts_json = invocation.facts();
              if let Some(route) = route { route.require_depth(1)?; }
              let args = crate::kernel::decode_entity_arguments(facts_json, &crate::kernel::ArgumentGates { decode_arguments: &crate::generated::generated_entity_no_identity::kiosk::LineSettleEntityArgs::decode_arguments, refuse_unknown_arguments: &crate::generated::generated_entity_no_identity::kiosk::LineSettleEntityArgs::refuse_unknown_arguments, refuse_absent_arguments: &crate::generated::generated_entity_no_identity::kiosk::LineSettleEntityArgs::refuse_absent_arguments, normalize_args: &|v: &crate::kernel::Json| { let args = crate::generated::generated_entity_no_identity::kiosk::LineSettleEntityArgs::from_json(v)?; Ok(args) }, refuse_role_mismatch: &|| Ok(()), resolve_references: &|_args: &crate::generated::generated_entity_no_identity::kiosk::LineSettleEntityArgs| Ok(()) })?;
