...
pub fn dispatch_by_name(
    ...
    match verb {
          "Bug28ExistenceFixture::Vault.Open" => {
              ...
              let args = if invocation.explicit_with() { let args = crate::kernel::decode_aggregate_arguments(facts_json, &crate::kernel::ArgumentGates { decode_arguments: &crate::generated::bug28_existence_fixture::vault::OpenArgs::decode_arguments, refuse_unknown_arguments: &crate::generated::bug28_existence_fixture::vault::OpenArgs::refuse_unknown_arguments, refuse_absent_arguments: &crate::generated::bug28_existence_fixture::vault::OpenArgs::refuse_absent_arguments, normalize_args: &|v: &crate::kernel::Json| { let args = crate::generated::bug28_existence_fixture::vault::OpenArgs::from_json(v)?; args.code.check_invariants()?; args.balance.check_invariants()?; Ok(args) }, refuse_role_mismatch: &|| Ok(()), resolve_references: &|_args: &crate::generated::bug28_existence_fixture::vault::OpenArgs| Ok(()) })?; if let Some(route) = route { route.require_depth(0)?; } args } else { if let Some(route) = route { route.require_depth(0)?; } crate::kernel::decode_aggregate_arguments(facts_json, &crate::kernel::ArgumentGates { decode_arguments: &crate::generated::bug28_existence_fixture::vault::OpenArgs::decode_arguments, refuse_unknown_arguments: &crate::generated::bug28_existence_fixture::vault::OpenArgs::refuse_unknown_arguments, refuse_absent_arguments: &crate::generated::bug28_existence_fixture::vault::OpenArgs::refuse_absent_arguments, normalize_args: &|v: &crate::kernel::Json| { let args = crate::generated::bug28_existence_fixture::vault::OpenArgs::from_json(v)?; args.code.check_invariants()?; args.balance.check_invariants()?; Ok(args) }, refuse_role_mismatch: &|| Ok(()), resolve_references: &|_args: &crate::generated::bug28_existence_fixture::vault::OpenArgs| Ok(()) })? };
              let tenant_boundary_check: Result<(), crate::kernel::Refusal> = Ok(());
              let owner_deref = Vec::new();
              let command_deref = crate::kernel::command_deref(&*store, REFERENCE_TABLE, &[], &args);
              let payload = crate::kernel::Json::overlay(facts_json, &args.to_json());
              crate::generated::bug28_existence_fixture::vault::dispatch_open(&mut store.vault, route, args, mutations, owner_deref, command_deref, tenant_boundary_check).map(|(_, events)| stamp_payload(events, &payload))
          }
