...
#[derive(Clone)]
pub struct Store {
    pub account: crate::kernel::InMemoryRepository<crate::generated::accounts_fixture::account::Account>,
}
...
if let Some(id) = key.strip_prefix("Accounts::Account#") {
    store.account.save(id, crate::generated::accounts_fixture::account::Account::from_json(value)?);
    continue;
}
            }
        }
...
pub fn dispatch_by_name(
    ...
    match verb {
          "Accounts::Account.Register" => {
              ...
              let args = if invocation.explicit_with() { let args = crate::kernel::decode_aggregate_arguments(facts_json, &crate::kernel::ArgumentGates { decode_arguments: &crate::generated::accounts_fixture::account::RegisterArgs::decode_arguments, refuse_unknown_arguments: &crate::generated::accounts_fixture::account::RegisterArgs::refuse_unknown_arguments, refuse_absent_arguments: &crate::generated::accounts_fixture::account::RegisterArgs::refuse_absent_arguments, normalize_args: &|v: &crate::kernel::Json| { let args = crate::generated::accounts_fixture::account::RegisterArgs::from_json(v)?; args.email.check_invariants()?; args.password_hash.check_invariants()?; Ok(args) }, refuse_role_mismatch: &|| Ok(()), resolve_references: &|_args: &crate::generated::accounts_fixture::account::RegisterArgs| Ok(()) })?; if let Some(route) = route { route.require_depth(0)?; } args } else { if let Some(route) = route { route.require_depth(0)?; } crate::kernel::decode_aggregate_arguments(facts_json, &crate::kernel::ArgumentGates { decode_arguments: &crate::generated::accounts_fixture::account::RegisterArgs::decode_arguments, refuse_unknown_arguments: &crate::generated::accounts_fixture::account::RegisterArgs::refuse_unknown_arguments, refuse_absent_arguments: &crate::generated::accounts_fixture::account::RegisterArgs::refuse_absent_arguments, normalize_args: &|v: &crate::kernel::Json| { let args = crate::generated::accounts_fixture::account::RegisterArgs::from_json(v)?; args.email.check_invariants()?; args.password_hash.check_invariants()?; Ok(args) }, refuse_role_mismatch: &|| Ok(()), resolve_references: &|_args: &crate::generated::accounts_fixture::account::RegisterArgs| Ok(()) })? };
              let tenant_boundary_check: Result<(), crate::kernel::Refusal> = Ok(());
              let owner_deref = Vec::new();
              let command_deref = crate::kernel::command_deref(&*store, REFERENCE_TABLE, &[], &args);
              let payload = crate::kernel::Json::overlay(facts_json, &args.to_json());
              crate::generated::accounts_fixture::account::dispatch_register(&mut store.account, route, args, mutations, owner_deref, command_deref, tenant_boundary_check).map(|(_, events)| stamp_payload(events, &payload))
          }
