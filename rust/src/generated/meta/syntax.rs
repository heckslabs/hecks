...
pub fn dispatch_keyword(
    ...
    crate::kernel::dispatch(
        ...
        None,
        |record| {
        if record.keywords.iter().any(|e| e.position == args.position.clone()) { return Err(crate::kernel::Refusal::AlreadyExists(crate::kernel::RefusalSite::AlreadyExistsEntityDuplicate.render(&[("entity", "Keyword"), ("aggregate", "Syntax"), ("identity", "position.value"), ("offered", &format!("{:?}", args.position.clone().value))]))); }
...
pub fn dispatch_argument(
    ...
    crate::kernel::dispatch(
        ...
        None,
        |record| {
        if record.arguments.iter().any(|e| e.position == args.position.clone()) { return Err(crate::kernel::Refusal::AlreadyExists(crate::kernel::RefusalSite::AlreadyExistsEntityDuplicate.render(&[("entity", "Argument"), ("aggregate", "Syntax"), ("identity", "position.value"), ("offered", &format!("{:?}", args.position.clone().value))]))); }
