...
RSpec.describe Hecks::Literal do
  describe ".render" do
    ...
    # collapse would produce: a numeric-looking string wears its own
    # quotes on the wire rather than being indistinguishable from the
    # bare digits a real Integer renders as (that collapse would send
    # "007" across the wire as the text `007`, identical to what `7`
    # itself would have written, and it would come back an Integer on
    # the other side — `where code == "007"` would then match nothing).
