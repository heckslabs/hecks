...
# arc): a fan-out dispatch that always minted `<aggregate>_id` for every
# target command, with no self-reference check, would refuse every dispatch
# to a command declared on the very aggregate it self-references
