...
| **AccountClosed** | Event | Raised by `CloseAccount`. |
| **AccountCredited** | Event | Raised by `Credit`. |
| **AccountDebited** | Event | Raised by `Debit`. |
| **AccountFrozen** | Event | Raised by `FreezeAccount`. |
...
| **BoxSurrendered** | Event | Raised by `Surrender`. |
...
| **CustomerSuspended** | Event | Raised by `Suspend`. |
...
| **KeyReturnDue** | Event | Raised by `Surrender`. |
...
| **Onboarding** | Saga | Starts on `OnboardingOpened`, ends on `AccountOpened`. |
